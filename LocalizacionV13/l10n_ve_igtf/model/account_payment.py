...
class account_payment(models.Model):
    ...
    anticipo_move_id = fields.Many2one('account.move', 'Id de Movimiento donde pertenece dicho pago')
            ...
            for det_pago in lista_pago:
                ...
                if tipo_pago=='outbound':
                    if tipo_persona=='supplier':
                        ...
                        id_move=self.registro_movimiento_pago(porcentage_igtf,monto_total,nombre_igtf)
                        idv_move=id_move.id # Aqui obtengo el id del registro de la tabla account_move y lo guarda en estado draft
                        valor=self.registro_movimiento_linea_pago(porcentage_igtf,idv_move,monto_total,nombre_igtf)
    ...
    def registro_movimiento_pago(self,igtf_porcentage,total_monto,igtf_nombre):
        name = igtf_nombre
    ...
    def registro_movimiento_linea_pago(self,igtf_porcentage,id_movv,total_monto,igtf_nombre):
